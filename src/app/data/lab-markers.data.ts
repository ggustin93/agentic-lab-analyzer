import { LabMarkerInfo, MarkerCategory } from '../models/lab-marker.model';

/**
 * 📊 Lab Markers Database
 * Comprehensive database of clinical laboratory markers with reference ranges,
 * clinical significance, and categorization for medical analysis.
 */

export const LAB_MARKER_CATEGORIES: Record<string, MarkerCategory> = {
  'Blood Count': { name: 'Blood Count', description: 'Complete Blood Count and related parameters', priority: 1, color: '#ef4444' },
  'Blood Indices': { name: 'Blood Indices', description: 'Red blood cell characteristics', priority: 2, color: '#f97316' },
  'White Blood Cell Differential': { name: 'White Blood Cell Differential', description: 'Types of white blood cells', priority: 3, color: '#eab308' },
  'Iron Studies': { name: 'Iron Studies', description: 'Iron metabolism markers', priority: 4, color: '#22c55e' },
  'Vitamins': { name: 'Vitamins', description: 'Vitamin levels and deficiencies', priority: 5, color: '#06b6d4' },
  'Metabolic': { name: 'Metabolic', description: 'Glucose and metabolic markers', priority: 6, color: '#3b82f6' },
  'Kidney Function': { name: 'Kidney Function', description: 'Renal function indicators', priority: 7, color: '#8b5cf6' },
  'Electrolytes': { name: 'Electrolytes', description: 'Essential minerals and salts', priority: 8, color: '#ec4899' },
  'Lipids': { name: 'Lipids', description: 'Cholesterol and triglycerides', priority: 9, color: '#f59e0b' },
  'Liver Function': { name: 'Liver Function', description: 'Hepatic enzymes and function', priority: 10, color: '#84cc16' },
  'Inflammation': { name: 'Inflammation', description: 'Inflammatory markers', priority: 11, color: '#14b8a6' },
  'Thyroid': { name: 'Thyroid', description: 'Thyroid function tests', priority: 12, color: '#6366f1' },
  'Reproductive Hormones': { name: 'Reproductive Hormones', description: 'Sex hormones and reproductive health', priority: 13, color: '#a855f7' },
  'Stress Hormones': { name: 'Stress Hormones', description: 'Cortisol and stress response', priority: 14, color: '#f43f5e' },
  'Cancer Markers': { name: 'Cancer Markers', description: 'Tumor markers and screening tests', priority: 15, color: '#64748b' }
};

export const LAB_MARKERS_DATABASE: Record<string, LabMarkerInfo> = {
  ...
  'hémoglobine': {
    ...
    alternativeNames: ['hemoglobin', 'hb', 'hgb'],
    criticalValues: { criticalLow: 7.0, criticalHigh: 20.0 }
  },
  'hématocrite': {
    name: 'Hématocrite',
    ...
    alternativeNames: ['hematocrit', 'hct', 'ht'],
    criticalValues: { criticalLow: 25.0, criticalHigh: 60.0 }
  },
  'globules rouges': {
    ...
    alternativeNames: ['rbc', 'red blood cells', 'erythrocytes'],
    criticalValues: { criticalLow: 2.5, criticalHigh: 7.0 }
  },
  'vgm': {
    ...
    alternativeNames: ['mcv', 'mean corpuscular volume']
  },
  'hcm': {
  ...
  'glycémie à jeun': {
    ...
    alternativeNames: ['fasting glucose', 'glucose', 'blood sugar'],
    criticalValues: { criticalLow: 40, criticalHigh: 400 }
  },
  'insulinémie à jeun': {
  ...
  'cholestérol ldl': {
    ...
    alternativeNames: ['ldl cholesterol', 'ldl', 'bad cholesterol']
  },
  'cholestérol hdl': {
